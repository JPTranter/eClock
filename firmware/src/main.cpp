...
// Battery thresholds â€” see clock_logic.h. Below LOW_BATTERY_PCT the clock shows
...
static int getBatteryPercent() {
    // If USB is connected, VBUS overrides the battery voltage â€” the divider
...
// holds its image with no power, this message survives total power loss â€” a
...
static void enterSleepMode() {
    ...
    // NOTE: this is drawSleepIcon(), NOT drawSleepingScreen() â€” the latter is the
...
g_ble_initialized = true;
    ...
    // Begin first sync attempt â€” the state is already STATE_SYNCING
    startSyncAttempt();
